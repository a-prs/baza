      ...
      '/theory/': [
        {
          ...
          items: [
            ...
            { text: 'AI-стек 2025', link: '/theory/21-ai-stack' },
            { text: 'Запуск MVP за неделю', link: '/theory/22-mvp-launch' },
            { text: 'Кастдев: интервью с пользователями', link: '/theory/23-customer-discovery' },
            { text: 'Каналы роста', link: '/theory/24-growth' },
            { text: 'Ценообразование AI-продуктов', link: '/theory/25-pricing' },
            { text: 'Метрики продукта', link: '/theory/26-product-metrics' },
          ],
        },
      ],
      ...
      '/practice/': [
        {
          ...
          items: [
            ...
            { text: 'Структурированное логирование', link: '/practice/55-logging' },
      ...
      '/solutions/': [
        {
          ...
          items: [
            ...
            { text: 'Реферральная программа', link: '/solutions/referral-bot' },
            { text: 'Бот-квалификатор лидов', link: '/solutions/lead-qualifier-bot' },
            { text: 'Новостной агрегатор с AI', link: '/solutions/news-aggregator-bot' },
          ],
        },
      ],
    },
